  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.07);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">民宿管理平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="商家编号" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiabianhao" autocomplete="off" placeholder="商家编号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="备注" class="input" v-if="tableName=='shangjia'">
