  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="反馈日期" prop="fankuiriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fankuiriqi" label="反馈日期" prop="fankuiriqi">
              <el-input v-model="ruleForm.fankuiriqi" 
                placeholder="反馈日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fankuineirong" label="反馈内容" prop="fankuineirong">
                    <span v-html="ruleForm.fankuineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
